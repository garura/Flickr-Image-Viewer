...
+(NSArray *)countryListfromPlaces:(NSArray *)places {
   NSMutableSet *countrySet = [[NSMutableSet alloc] init];
   for (NSDictionary *place in places) {
      [countrySet addObject:[[[place valueForKeyPath:FLICKR_PLACE_NAME] componentsSeparatedByString:@", "] lastObject]];
   }
   NSMutableArray *countryList = [[NSMutableArray alloc] init];
   for (NSString *country in countrySet) {
...
+(NSDictionary *)placesFromCountries:(NSArray *)country inPlaces:(NSArray *)places {
   NSMutableDictionary *placesFromCountry = [[NSMutableDictionary alloc] init];
   for (NSString *inCountry in country) {
      NSMutableArray* placesInCountry = [[NSMutableArray alloc] init];
      for (NSDictionary *place in places) {
         if ([[[[place valueForKeyPath:FLICKR_PLACE_NAME] componentsSeparatedByString:@", "] lastObject] isEqualToString:inCountry]) {
            [placesInCountry addObject:place];
         }
      }
      placesFromCountry[inCountry] = placesInCountry;
   }
   return placesFromCountry;
}
